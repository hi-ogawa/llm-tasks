...
- Works best when asking for _descriptions_ rather than exact notation (e.g., "describe a bass fill connecting Em to G" then manually transcribe)
...
3. Prompt: _"Here's the verse bassline in ABC notation: [paste]. Extend this pattern for 3 more verses maintaining the groove and root movement."_
...
3. Prompt LLM: _"This bass transcription has errors. Given the chord progression [C - Am - F - G], correct the notes that don't fit and fill in the rhythm: [paste rough transcription]"_
...
2. Prompt: _"Generate a [genre] bass line for this progression: Dm7 | G7 | Cmaj7 | Fmaj7 in 4/4 at 120bpm"_
